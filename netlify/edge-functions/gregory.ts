...
export default async (req: Request) => {
  ...
  const consigne = demande
    ? `
Amène ${demande} sous forme de QUESTION douce et polie, jamais à l'impératif : "donnez-moi", "passez-moi", "laissez-moi", "envoyez-moi" sont INTERDITS. Préfère des tournures comme "vous me laissez un numéro où vous joindre ?", "quel est le meilleur numéro pour vous joindre ?", "on peut se joindre à quel numéro ?". Si c'est la toute première demande, une demi-phrase de justification (rappel gratuit pour faire le point) ; sinon aucune justification, juste la question, courte et variée. EXCEPTION PRIORITAIRE sur tout le reste : si le dernier message du visiteur est une pique, un reproche sur ton insistance ou une demande de ralentir (du calme, doucement, vous insistez, vous lâchez pas...), tu ne poses AUCUNE question et tu ne redemandes RIEN dans ce message : une phrase d'autodérision ou de détente, point final. La demande attendra qu'il relance. Et jamais, sous aucun prétexte, la même formulation de demande deux fois dans une conversation.`
    : "";
